Data Visualization with ggplot2 {#ch05}
=======================================
...
- 使用模板繪製散布圖：
  ...
  ```{r echo=F, fig.cap="`ggplot()` 的結構", out.width="50%"}
...
- `geom_bar()` 在繪製長條圖之前，為符合繪圖需求而將傳入的 data frame 進行的運算，稱為 Statistical Transformation:
  ...
  ```{r echo=F, fig.cap="`geom_bar()`'s default statistical transformation<br>Source: <https://r4ds.had.co.nz/data-visualisation.html#statistical-transformations>"}
